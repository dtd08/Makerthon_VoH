...
- [프로젝트 개요](#프로젝트:-*BoH-GPT-(Beacon-of-Hearts)*-개요)
- [실행 방법](#실행-방법)
- [마무리](#프로젝트를-마무리하며)
- [시연 영상](#시연-영상)
- [문의](#문의)
...
: 초반에는 그저 *상담 가능한* 챗봇에 초점을 뒀지만 개발을 진행하면서 좀 더 친구같으면 좋겠다 싶어 챗봇에게 꽉두팔이라는 귀여운 마스코트와 이름,
'친근한 성격을 가지고 타인을 돕길 좋아하는 친구'라는 인격을 주어주고 반말로 대화하게 만들었습니다.
2. **분야 집중을 위한 설문조사** <br/>
: 개발 도중 멘토님께서 청소년들이 정말로 고민인 부분이 무엇일까 고려해보라는 조언에 따라 설문조사로 그들의 고민을 알아보았습니다.
...
### 소감
- **이서영** <br/>
: AI 모델 개발 대회에 참가하는 것은 처음이라 많이 긴장했었는데 편안한 분위기로 이끌어주셔서 팀원들과 더 활발하게 소통 가능했던 것 같습니다. <br/>
우리 팀 정말 고생 많았고 이번 기회가 AI를 이해하는 중요한 경험이 되었으면 좋겠습니다.
- **양준석** <br/>
: UI를 구현하면서 다른 팀원들과 상의하면서 하니깐 대회를 진행하던 2일 내내 즐거운 시간이였습니다. 대회를 통해 저의 코딩 실력과 커뮤니케이션 능력 늘어나는 좋인 기회였던것 같습니다
- **김규민** <br/>
: 다른 팀원들과 커뮤니케이션하며 프로젝트를 진행하는게 너무 즐거웠고 다른 팀들이랑 대화하면서 서로 기술을 공유했던 시간이 아주 유익했습니다.
- **장연준** <br/>
: 첫 대회를 나와서 팀원들과 함깨 첫 프로젝트를 같이 진행하면서 즐거움도 있었고 신기함도 있었다. 이런 경험을 할수 있어 좋고 유익한 시간이였습니다.
